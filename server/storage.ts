...
export interface IStorage {
  ...
  updateUserStripeInfo?(
    userId: number,
    stripeInfo: { stripeCustomerId: string }
...
export class MemStorage implements IStorage {
  ...
  private async initializeDefaultData() {
    ...
    this.upsertAboutSection({
      ...
      chefImage:
        "https://images.unsplash.com/photo-1566554273541-37a9ca77b91f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=128&q=80",
    });
    ...
    await this.createMenuItem({
      ...
      description:
        "Crispy pastry filled with spiced potatoes, peas, and aromatic spices. Served with tamarind chutney.",
      price: "$7.99",
      image:
        "https://images.unsplash.com/photo-1567188040759-fb8a883dc6d8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=80",
      spiceLevel: "Medium",
      isVegetarian: true,
      isVegan: false,
      isGlutenFree: false,
    ...
    this.createMenuItem({
      ...
      name: "Butter Chicken",
      description:
        "Tender chicken cooked in a rich tomato and butter sauce with aromatic spices. Served with basmati rice.",
      price: "$16.99",
      image:
        "https://images.unsplash.com/photo-1585937421612-70a008356a82?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=80",
      spiceLevel: "Mild",
      isVegetarian: false,
      isVegan: false,
      isGlutenFree: true,
    ...
    this.createMenuItem({
      ...
      name: "Palak Paneer",
      description:
        "Fresh cottage cheese cubes in a creamy spinach sauce with aromatic spices. Served with basmati rice.",
      price: "$14.99",
      image:
    ...
    this.createMenuItem({
      ...
      name: "Garlic Naan",
      description:
        "Traditional leavened flatbread baked in a tandoor oven, topped with garlic and fresh cilantro.",
      price: "$3.99",
      image:
        "https://images.unsplash.com/photo-1605653411309-11cc3c87a86b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=80",
      spiceLevel: "None",
      isVegetarian: true,
      isVegan: false,
      isGlutenFree: false,
    ...
    this.createMenuItem({
      ...
      name: "Gulab Jamun",
      description:
        "Soft milk solids dumplings soaked in rose-flavored sugar syrup. Served warm with a touch of cardamom.",
      price: "$5.99",
      image:
        "https://images.unsplash.com/photo-1593250186288-c82cb5d6a1a0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=80",
      spiceLevel: "None",
      isVegetarian: true,
      isVegan: false,
      isGlutenFree: false,
    ...
    this.createMenuItem({
      ...
      name: "Masala Chai",
      description:
        "Traditional Indian spiced tea prepared with a blend of aromatic spices, milk, and sweetener.",
      price: "$3.49",
      image:
        "https://images.unsplash.com/photo-1572097662444-9c6a7d8d0544?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=80",
      spiceLevel: "None",
      isVegetarian: true,
      isVegan: false,
      isGlutenFree: true,
    ...
    this.createGalleryImage({
      ...
      image:
        "https://images.unsplash.com/photo-1585937421612-70a008356a82?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
    ...
    this.createGalleryImage({
      ...
      image:
        "https://images.unsplash.com/photo-1506368249639-73a05d6f6488?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
    ...
    this.createGalleryImage({
      ...
      image:
        "https://images.unsplash.com/photo-1532634922-8fe0b757fb13?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
  ...
  async upsertRestaurantInfo(
    info: InsertRestaurantInfo
  ...
  async getAllMenuCategories(): Promise<MenuCategory[]> {
    return Array.from(this.menuCategoriesData.values()).sort(
  ...
  async getFeaturedMenuItems(): Promise<MenuItem[]> {
    return Array.from(this.menuItemsData.values()).filter(
      (item) => item.featured
    );
  }
  ...
  async getAllReservations(): Promise<Reservation[]> {
    return Array.from(this.reservationsData.values()).sort(
      (a, b) =>
